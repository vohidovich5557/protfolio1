  ...
  return (
    <>
      <div className="container flex flex-col items-center justify-center mt-[124px]">
        ...
        <p
          className="w-full h-auto text-md text-black/50 text-center md:w-[584px] md:text-left"
          data-aos="fade-right"
        >
          Things I’ve built so far
        </p>
        <div
          className="grid grid-cols-1 ml-[-8px] gap-[47px] md:grid-cols-2 lg:grid-cols-3 mt-[30px]"
          data-aos="fade-right"
        >
          {cardData.map((item) => (
              <ProjectCard
