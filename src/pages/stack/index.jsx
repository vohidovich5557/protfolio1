...
export const Stack = () => {
    return (
        <>
            <div className="container items-center justify-center mt-[124px]" data-aos="fade-right">
                ...
                <div className=" grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 lg:gap-[109px] md:gap-[60px] gap-[10px] mt-[110px]">
                    {imgData.map((item) => (
                        <div className="w-[120px] h-[120px] ml-auto mr-auto flex items-center justify-center" data-aos={item.aos} data-aos-duration="3000">
