  ...
  return (
    <>
      <div className="container flex flex-col items-center justify-center mt-[20px]">
        ...
        <div className="flex items-center mb-[60px] justify-center gap-[50px]">
          <a target="_blank" href={result.link}>
            <div className="w-[570px] shadow-lg shadow-gray-400 ">
              <img src={result.img} alt="" />
            </div>
          </a>
          <div className="w-[570px] flex flex-col items-start">
            <div className="w-[100%] h-[3px] mb-[30px] bg-gray-300"></div>
            <p className="text-xl font-bold text-blue-950 mb-[10px]">
              {result.comment1}
            </p>
            <div className="w-[100%] h-[3px] mb-[30px] bg-gray-300"></div>
            <p className="text-xl font-bold text-blue-950 mb-[10px]">
        ...
        <div className="flex flex-col items-start">
          <h2 className="text-4xl font-bold text-red-600 mb-[20px]">
            Ishlatilgan Toolar
          </h2>
          <div className="flex flex-col">
            <div className="w-[600px] ml-auto mr-auto mb-[10px] h-[2px] bg-gray-400"></div>
            <div className="flex items-center mb-[20px] gap-[20px]">
